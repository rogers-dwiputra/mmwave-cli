...
full_config = {
    'profileCfg': {
        'profileId': 0,
        'pfVcoSelect': 0x02,
        'startFreqConst': config_dict["mimo"]["profile"]["startFrequency"],
        'freqSlopeConst': config_dict["mimo"]["profile"]["frequencySlope"],
        'idleTimeConst': config_dict["mimo"]["profile"]["idleTime"],
        'adcStartTimeConst': config_dict["mimo"]["profile"]["adcStartTime"],
        'rampEndTime': config_dict["mimo"]["profile"]["rampEndTime"],
        'txOutPowerBackoffCode': 0x0,
        'txPhaseShifter': 0x0,
        'txStartTime': config_dict["mimo"]["profile"]["txStartTime"],
        'numAdcSamples': config_dict["mimo"]["profile"]["numAdcSamples"],
        'digOutSampleRate': config_dict["mimo"]["profile"]["adcSamplingFrequency"],
        'hpfCornerFreq1': config_dict["mimo"]["profile"]["hpfCornerFreq1"],
        'hpfCornerFreq2': config_dict["mimo"]["profile"]["hpfCornerFreq2"],
        'rxGain': config_dict["mimo"]["profile"]["rxGain"],
    },
    'frameCfg': {
        'chirpStartIdx': 0,
        'chirpEndIdx': 11,
